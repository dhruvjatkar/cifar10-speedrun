...
def main(run, model):
    ...
    # CutMix config: fixed 3x3 patch, 50% probability, last 50% of training
    cutmix_size = 3
    cutmix_prob = 0.5
    ...
    for epoch in range(ceil(total_train_steps / len(train_loader))):
        ...
        for inputs, labels in train_loader:
            ...
            # Apply fixed-patch CutMix with 50% probability in last 50% of training
            if step >= cutmix_start_step and torch.rand(1).item() < cutmix_prob:
