...
def main(run, model):
    ...
    # CutMix config: fixed 3x3 patch, last 50%, reduced LS during CutMix
    cutmix_size = 3
    cutmix_start_step = total_train_steps // 2

    # Compile the forward pass function for soft labels (CutMix)
    ...
    for epoch in range(ceil(total_train_steps / len(train_loader))):
        ...
        for inputs, labels in train_loader:
            ...
            if step >= cutmix_start_step:
                ...
                n_classes = 10
                smooth = 0.05  # Reduced LS during CutMix to avoid double-smoothing
