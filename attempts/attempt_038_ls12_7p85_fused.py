...
def main(run, model):
    ...
    # Compile the forward+backward pass function
    @torch.compile(mode="max-autotune", fullgraph=True)
    def train_step(inputs, labels, whiten_bias_grad):
    ...
    for epoch in range(ceil(total_train_steps / len(train_loader))):
        ...
        for inputs, labels in train_loader:
            ...
            # Execute fused training step (forward + backward)
            loss = train_step(inputs, labels, whiten_bias_grad)
