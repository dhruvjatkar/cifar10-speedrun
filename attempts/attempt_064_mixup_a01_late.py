...
def main(run, model):
    ...
    # MixUp config: very small alpha, applied in last 50% of training
    mixup_alpha = 0.1
    mixup_start_step = total_train_steps // 2
    ...
    for epoch in range(ceil(total_train_steps / len(train_loader))):
        ...
        for inputs, labels in train_loader:
            ...
            # Apply MixUp (alpha=0.1) in last 50% of training
            if step >= mixup_start_step:
