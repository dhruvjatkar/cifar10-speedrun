...
# Attempt 126: Hybrid Neumann+CG compiled resolvent.
# Large shifts (σ>1) use Neumann series in FP16 (fast, tensor-core friendly).
# Small shifts (σ<1) use CG in FP32 (stable, converges for ill-conditioned systems).
# 4 terms total: 2 Neumann (FP16) + 2 CG (FP32). Compiled, no bucket loop.
    ...
    def step(self):
        ...
        if group["orthogonalization_backend"] == "newtonschulz":
            ...
            final_orthogonalized_grads = _zeropower_via_resolvents(
                ...
                neumann_iters=group["neumann_iters"],
                shift_threshold=group["shift_threshold"],
            )
...
if __name__ == "__main__":
    ...
    print(
        ...
        f" | neumann_iters={args.neumann_iters}"
        f" | shift_threshold={args.shift_threshold}"
    )
    ...
    if not args.skip_warmup:
        main(
            ...
            neumann_iters=args.neumann_iters,
