...
def main(run, model):
    ...
    # CutMix config: fixed 3x3 patch, applied in last 2 epochs only
    cutmix_size = 3
    cutmix_start_step = total_train_steps - ceil(2.0 * len(train_loader))
    ...
    for epoch in range(ceil(total_train_steps / len(train_loader))):
        ...
        for inputs, labels in train_loader:
            ...
            # Apply fixed-patch CutMix in last 2 epochs of training
