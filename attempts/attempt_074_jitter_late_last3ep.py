...
def main(run, model):
    ...
    # Doubled color jitter only in last 3 epochs
    jitter_boost_start_step = total_train_steps - ceil(3.0 * len(train_loader))
    ...
    for epoch in range(ceil(total_train_steps / len(train_loader))):
        ...
        for inputs, labels in train_loader:
            ...
            # Apply extra color jitter in last 50% of training
