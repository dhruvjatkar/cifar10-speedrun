...
def main(run, model):
    ...
    # CutMix config: fixed 3x3 patch, applied in last 3 epochs only
    cutmix_size = 3
    cutmix_start_step = total_train_steps - ceil(3.0 * len(train_loader))

    # Compile the soft-label forward pass function
    ...
    for epoch in range(ceil(total_train_steps / len(train_loader))):
        ...
        for inputs, labels in train_loader:
            ...
            # Apply fixed-patch CutMix in last 3 epochs of training
